...
print("Known issues:")
print("- - - - - - - - -") 
print("When you delete a row, and try to add a new one... logic isn't currently smart enough to handle incrementing to the next available UNIQUE ID value.\n")
print("Noteworthy:")
print("- - - - - - - - -")
print("Current structure of code doesn't save the database values when application restarts. Set up this way on purpose for use case testing.\n\n")
